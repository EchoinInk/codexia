...
const workspaceCaches =
  new Map<string, WorkspaceCacheEntry>();
...
export function hasWorkspaceCache(
  workspace: string
): boolean {

  return workspaceCaches.has(
    workspace
  );
...
export function getWorkspaceCacheAge(
  workspace: string
): number {
